...
from .knowledge_commands import ClearCommand as ClearKnowledgeCommand
from .knowledge_commands import LoadCommand, vector_store
...
CommandFactory.register("copy", CopyCommand)
